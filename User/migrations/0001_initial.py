    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp_enabled', models.BooleanField(default=False, verbose_name='OTP Enabled')),
                ('otp_verified', models.BooleanField(default=False, verbose_name='OTP Verified')),
                ('otp_base32', models.CharField(max_length=255, null=True, verbose_name='OTP Base32')),
                ('otp_auth_url', models.CharField(max_length=255, null=True, verbose_name='OTP Auth URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.CharField(default='<function uuid4 at 0x00000154D7ABF6D0>', max_length=200)),
                ...
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='Location.location', verbose_name='Location')),
